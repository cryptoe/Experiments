...
serverapp.listen(SERVER_PORT, function() {
  console.log('Started server at <a href="http://127.0.0.1:">  http://127.0.0.1:  </a>' + SERVER_PORT);
});
...
clientapp.listen(CLIENT_PORT, function() {
  console.log('Started client at <a href="http://localhost:">  http://127.0.0.1:  </a>' + CLIENT_PORT);
});
